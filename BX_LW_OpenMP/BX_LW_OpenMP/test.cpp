...
#pragma omp for nowait
        for (int i = 0; i < array1.size(); ++i) {
            if (binary_search(array2.begin(), array2.end(), array1[i])) {
                local_results[tid].push_back(array1[i]);
            }
        }
    }
